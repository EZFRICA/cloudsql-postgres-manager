...
from app.components.base_responses import (
    ErrorResponse, ValidationErrorResponse, DatabaseErrorResponse, NotFoundErrorResponse
)
...
class ErrorHandler:
    ...
    def handle_validation_error(
        ...
        logger.warning(f"Validation error: {len(validation_errors)} field(s) failed validation")
