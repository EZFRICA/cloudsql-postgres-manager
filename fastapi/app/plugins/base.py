...
class RoleDefinition(BaseModel):
    ...
    native_roles: List[str] = Field(
        default=[], description="PostgreSQL native roles granted"
    )
    ...
    def is_outdated(self, other: "RoleDefinition") -> bool:
        ...
        return self.version != other.version or self.checksum != other.checksum
...
class RolePlugin(ABC):
    ...
    def validate_role_definition(self, role_def: RoleDefinition) -> bool:
        ...
        """
        dangerous_permissions = ["SUPERUSER", "CREATEDB", "CREATEROLE", "REPLICATION"]
