...
class FirestoreRoleRegistryManager:
    ...
    def _get_document_id(self, project_id: str, instance_name: str, database_name: str) -> str:
        """
    ...
    def get_role_registry(self, project_id: str, instance_name: str, database_name: str) -> Optional[FirestoreRoleRegistry]:
        """
    ...
    def save_role_registry(self, project_id: str, instance_name: str, database_name: str, 
                          registry: FirestoreRoleRegistry) -> bool:
        """
    ...
    def update_role_registry(self, project_id: str, instance_name: str, database_name: str,
    ...
    def add_creation_history_entry(self, project_id: str, instance_name: str, database_name: str,
                                 action: str, roles_affected: list, success: bool, 
    ...
    def check_roles_initialized(self, project_id: str, instance_name: str, database_name: str) -> bool:
        """
    ...
    def get_registry_status(self, project_id: str, instance_name: str, database_name: str) -> Optional[Dict[str, Any]]:
        """
