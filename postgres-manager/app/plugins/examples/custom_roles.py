...
class CustomRolePlugin(RolePlugin):
    ...
    def get_role_definitions(
        self, db_name: str = "app", schema_name: str = "public"
    ) -> List[RoleDefinition]:
        """
    ...
    def _create_data_scientist_role(
    ...
    def _create_analytics_readonly_role(
        self, db_name: str, schema_name: str
    ) -> RoleDefinition:
    ...
    def validate_role_definition(self, role_def: RoleDefinition) -> bool:
        ...
        for command in role_def.sql_commands:
            ...
            if any(
                perm in command_upper
                for perm in ["SUPERUSER", "CREATEDB", "CREATEROLE"]
            ):
                return False
