...
class DatabaseValidator:
    ...
    def validate_schema_name(schema_name: str) -> str:
        ...
        """
        return PostgreSQLValidator.validate_schema_name(schema_name)

    @staticmethod
    def validate_database_name(database_name: str) -> str:
        """
        Validate database name according to PostgreSQL standards.
        ...
        """
        return PostgreSQLValidator.validate_identifier(database_name, "database_name")
